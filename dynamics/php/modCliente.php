        ...
        if (isset($_SESSION['idClient'])) {
            ...
            if ($result) {
                ...
                if ($row = mysqli_fetch_array($result)) {
                    echo "<h3>Se ha seleccionado el cliente: " . utf8_encode($row[1]) . " " . utf8_encode($row[2]) . "</h3>";
                    echo "<h3>Correo Electronico:" . utf8_encode($row[3]) . "<br>Telefono:" . utf8_encode($row[4]) . "</h3>";
